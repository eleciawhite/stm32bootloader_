...
DEVICE_TABLE = [
	...
	# H7
	(0x483, "STM32H72xxx/73xxx"               , 0x20004100, 0x20020000, 0x80000000, 0x08100000,  1, p_128k, 0         , 0         , 0x1FF00000, 0x1FF1E800, 0),
...
KEYS = [
    ...
    "system_mem_start", "system_mem_end",
    "flag",
]

DEVICES = [
    dict(zip(KEYS, details))
    for details in DEVICE_TABLE
]